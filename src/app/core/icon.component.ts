...
const PATHS: Record<string, string> = {
  ...
  settings: `<path d="M6.9 1.5h2.2l.4 1.6c.4.1.7.3 1 .5l1.5-.7 1.1 1.9-1.2 1.1c.1.4.1.7.1 1.1s0 .7-.1 1.1l1.2 1.1-1.1 1.9-1.5-.7c-.3.2-.6.4-1 .5l-.4 1.6H6.9l-.4-1.6c-.4-.1-.7-.3-1-.5l-1.5.7-1.1-1.9 1.2-1.1C4 8.7 4 8.4 4 8s0-.7.1-1.1L2.9 5.8 4 3.9l1.5.7c.3-.2.6-.4 1-.5l.4-1.6z" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"/><circle cx="8" cy="8" r="2.1" fill="none" stroke="currentColor" stroke-width="1.35"/>`,
